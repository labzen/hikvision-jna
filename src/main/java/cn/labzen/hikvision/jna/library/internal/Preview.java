...
public interface Preview {
  ...
  /**
   * 5.7 - [实时数据回调和录像]： 注册回调函数，捕获实时码流数据（标准码流）
   * <p/>
   * <ul>
  ...
  /**
   * 5.7 - [实时数据回调和录像]： 按指定的目标封装格式捕获数据并存放到指定的文件中
   * <p/>
   * <ul>
  ...
  /**
   * 5.9 - [设备抓图]： 单帧数据捕获并保存成JPEG存放在指定的内存空间中
   * <p/>
   * <ul>
